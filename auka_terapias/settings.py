"""
Django settings for auka_terapias project.
"""
...
ROOT_URLCONF = 'auka_terapias.urls'
...
WSGI_APPLICATION = 'auka_terapias.wsgi.application'
...
# En producción usa Supabase PostgreSQL, en desarrollo usa SQLite
DATABASE_URL = config('DATABASE_URL', default=None)

if DATABASE_URL:
    # Producción: usar Supabase PostgreSQL
    DATABASES = {
...
# Media files
MEDIA_URL = '/media/'
MEDIA_ROOT = BASE_DIR / 'media'  # si BASE_DIR es Path; si es str usa os.path.join(BASE_DIR, 'media')
